...
<template>
  <div class="max-w-[217px]">
    <button class="relative">
      <div>
        <svg
          class="absolute bottom-0 py-1 mt-4 max-w-[40px] bg-[rgba(0,0,0,.45)] fill-slate-50"
      ...
      <div class="m-auto bg-[300ms] select-none">
        <img :src="image" />
      </div>
    </button>
    ...
    <div class="flex">
      ...
      <span class="mt-[1px] font-semibold text-[#959595]">
        {{ rating }}% ({{ commentsCount }})</span
      >
    </div>
    <span class="text-base font-semibold text-red-600">{{ price }}грн</span>
  </div>
</template>
